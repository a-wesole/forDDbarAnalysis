...
try:
    compile_command = [
        "g++",
        "event_mixing_for_acceptance_correction_v2.C",
        "../src/BDTHandler.cc",
        "../src/phiTools.cc",
        "-I../include",
    ...
    # print("run ./eventMix2.exe <istart> <iend>")
    # print("last was ./eventMix2.exe 0 50")
    # exit(1)
...
class jobs_submission():
    ...
    def build_job_files(self, job_name):
        ...
        with open(subfile, "w") as fsub:
            ...
            fsub.write(f'./eventMix2.exe {self.istart} {self.iend} \n')
...
if __name__ == "__main__":
    base_dir = "/scratch/negishi/awesole/DDbar_eventmixing"
